...
if(isset($_POST['search'])){
    ...
    $sql = "SELECT * FROM student WHERE deleted_at = 1 LIMIT $start_form,$num_per_page"; 
}
                ...
                <div class="col-mt-5">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-body">
                                <a href="index.php"><button class="btn btn-success">View</button></a>
                                ...
                                <table class="table table-dark table-striped-coloumns">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="restore1.php?id=<?php echo $row['id']?>"><button class="btn btn-primary">Restore</button></a> 
                                ...
                                $total_pages=ceil($total_recorde/$num_per_page);

                                echo "<ul class='pagination admin-pagination'>";
                                for($i=1;$i<=$total_pages;$i++){
                                    echo "<li>
                                   <a href='restore.php?page=" . $i . "'>
